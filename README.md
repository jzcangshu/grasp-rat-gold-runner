...
- 支持“自动射击”开关：未手动锁定时自动选择 150m 红圈内 HP 最低敌人，按目标运动轨迹、相对距离和子弹速度做短时预判后点击射击，并按 5 秒体力余量动态限制射速。
- HUD 左上侧提供 170m 攻击缓冲范围敌人列表，显示用户名、HP 和距离；点击可锁定自动射击目标，目标仍在 500m 视野内时不会自动切换。
